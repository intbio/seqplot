...
class geom_seq_x(geom_tile):
    ...
    def __init__(self, seqimg=None, x=None, y=None, aspect_ratio=0.1, mapping=None, data=None, **kwargs):
...
#         dy=103.
        ...
        a=aspect_ratio
        dh=dy*f/(a-f)
        pict.x=pict.x/imgdx*dx-0.5+x.min()
        pict.y=pict.y/imgdy*dh+y.min()
